        ...
        <form action="${pageContext.request.contextPath}/serviceItem/insert" method="post">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input class="form-control" id="durationMinutes" name="durationMinutes" type="number" min="1" required>
                </div>
            </div>
            <div class="mb-4">
            ...
            <div class="d-flex gap-2">
                ...
                <button class="btn btn-primary w-50" type="submit">등록</button>
            </div>
        </form>
    </section>
</main>
