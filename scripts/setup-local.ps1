...
$credentialDirectory = Join-Path ([Environment]::GetFolderPath([Environment+SpecialFolder]::UserProfile)) '.marinboy-salon\credentials'
...
if ($StartRedis) {
    ...
    # 저장소의 compose 설정으로 JWT 로그아웃 토큰을 보관할 Redis만 시작합니다.
