    ...
    <div className="table-responsive paper-table-wrap"><table className="table align-middle">
      <thead><tr><th>고객</th><th>시술</th><th>예약 일시</th><th>요청사항</th><th>상태</th><th>결제</th></tr></thead><tbody>
        {reservations.map((item) => {
          ...
          </td><td><Link className="outline-button payment-detail-button" href={`/admin/reservations/payment?id=${item.id}`} target="_blank" rel="noopener noreferrer">상세·결제 보기</Link></td></tr>;
        })}
      </tbody></table></div>
  </section></AppLayout>;
}
